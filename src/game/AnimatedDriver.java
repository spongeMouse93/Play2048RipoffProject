 ...
 * 
 * - Follow the numbered prompts on the StdDraw window to test individual
 * methods.
 * - When you see a board, press any key to test and any key again to test
 * another method or quit.
 * - When playing the entire game, use W, A, S, and D keys to move up, left,
...
public class AnimatedDriver {
    ...
    private static void testIndividualMethods(Collage boardCollage) {
        String[] methods = { "updateOpenSpaces", "addRandomTile", "swipeLeft", "mergeLeft", "transpose", "flipRows",
                "makeMove" }, options = { "Test a new input file", "Test a method using this input file", "Quit" };
    ...
    private static String getFileChoice() {
        ...
        ArrayList<String> choices = new ArrayList<>(), files = new ArrayList<>();
